...
describe('watcher', () => {
  ...
  test('should rebuild on source file change', async () => {
  ...
  test('should rebuild on a source file change after a failed transformation', async () => {
    await outputFS.mkdirp(inputDir);
    await outputFS.writeFile(
      path.join(inputDir, '/index.js'),
      'syntax\\error',
  ...
  test('should rebuild on a config file change', async () => {
  ...
  test('should rebuild properly when a dependency is removed', async () => {
  ...
  test.skip('should re-generate bundle tree when files change', async function() {
  ...
  test.skip('should only re-package bundles that changed', async function() {
    await ncp(path.join(__dirname, '/integration/dynamic-hoist'), inputDir);
    let b = bundler(path.join(inputDir, '/index.js'), {watch: true});
  ...
  test.skip('should unload assets that are orphaned', async function() {
    await ncp(path.join(__dirname, '/integration/dynamic-hoist'), inputDir);
    let b = bundler(path.join(inputDir, '/index.js'), {watch: true});
  ...
  test.skip('should recompile all assets when a config file changes', async function() {
  ...
  test.skip('should rebuild if the file behind a symlink changes', async function() {
    await ncp(
  ...
  test('should add and remove necessary runtimes to bundles', async () => {
