...
describe('loadSourceMap', () => {
  test('should not match sourceMappingURL when not at the end of the bundle', () => {
  ...
  test('should match referenced sourceMappingURL when correctly inserted at end of the bundle', () => {
    let code = fs.readFileSync(
  ...
  test('should match inline sourceMappingURL when correctly inserted at end of the bundle', () => {
